...
import {
  Card, CardContent, TextField, Button, Typography, Box, Container, Alert,
  Divider, MenuItem, FormControl, InputLabel, Select
} from '@mui/material';
...
export default function Register() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // Patient details object to pass to your API
      ...
      // Call custom registration function (creates account in Auth table/db)
      ...
      if (res.user && res.user.id) {
        ...
        if (insertError) {
          console.error('Error inserting patient record:', insertError);
        } else {
